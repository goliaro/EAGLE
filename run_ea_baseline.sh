...
# python -m eagle.evaluation.gen_ea_answer_llama3chat_simplified --trace-path /home/jovyan/pscratch/suffix-tree-decoding/trace/llama70b/cortex-llama3-70b.json --output-file ./scratch.json --partitions FEATURE_EXTRACTION --max-requests-per-partition 1

python -m eagle.evaluation.gen_suffix_decoding_answer_llama3chat_simplified --trace-path /home/jovyan/pscratch/suffix-tree-decoding/trace/llama70b/cortex-llama3-70b.json --output-file ./scratch.json --partitions FEATURE_EXTRACTION --max-requests-per-partition 1
